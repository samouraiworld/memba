...
- **W-M0 · Honesty + copy quick-fixes (ship first, tiny).** MH-02 WalletChips `rawUgnot>0n` honesty fix (TDD) + MH-13 "1 token(s)" pluralization. Independent of the redesign; lands immediately. *Effort S.*
