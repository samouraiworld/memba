...
> **Status (updated 2026-07-09):** 🟢 IN IMPLEMENTATION on `feat/marketplace-v2` — Phases 0–4 + 7 (lane rebuilds + flag-gated cutover) DONE; 20 commits, 120 tests green, build clean, behind `VITE_ENABLE_MARKETPLACE_V2` (off in prod). **To resume, read [`MARKETPLACE_V2_HANDOFF_2026-07-09.md`](./MARKETPLACE_V2_HANDOFF_2026-07-09.md) first.** Remaining (gated): Phase 5 (mobile trade sheet — needs a real listing/e2e), Phase 6 (reviews realm — needs deployer `nft_market_v3_2` getter), Phase 8 (e2e/docs/cutover-flip). Per-phase detail below is kept current with ✅/deferred markers.
