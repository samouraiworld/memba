...
> **Status:** decisions RULED by owner 2026-08-16 — **D3(b) = wire to fee spine · engine = v3.2 only · legacy v2 stack = skip**. Prep work in progress; ceremony execution pending scheduling (§7).
