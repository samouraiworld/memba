...
func TestA3_RealAdenaSignature(t *testing.T) {
    err := auth.VerifyMultisigMemberSignature(
        ...
        auth.StoredTxFields{
            ChainID: "gnoland-1", AccountNumber: <n>, Sequence: <n>, // the chain the signature was captured on
