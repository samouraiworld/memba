...
- Frontend commit: `e6424909d3562f22edfc46d5af4304d45900d1cb`, v7.7.0, following the owner’s merge of #1235.
- Netlify site: `memba-multisig`; production deploy: `6ab18e2814160e000886c272` (published 2026-09-21 20:06 UTC). `build-info.json` identifies the exact merged commit and entry `assets/index-B5ANmuyt.js`.
- Custom domain and immutable deploy HTML share SHA-256 `e9d06b56bd98a3f69fc17362e6fb5b372d59a0c4047bee323fe89ec76c5e7a6c`. The returning production browser adopted the new entry after its service-worker update and reload, and Home rendered normally. A fresh immutable-origin browser rendered Home and the lazy-loaded Blog route. No wallet was connected or used.
...
| B1+B2 scoped creation drafts and durable approval recovery | `ca007b3906c011c4cd510498d120cbfdc691f3f6`; independent CTO + SWE approval after merging current main | Original slice full unit: 561 files, 5,616 tests; lint/build/bundle; updated-head focused recovery and wallet integration: 74 tests pass; required hosted checks green; supplemental browser checks running; Chromium, Firefox and iPhone WebKit mocked mainnet submission → reload during polling → inert-status recovery; one wallet call; 320/390/1440px layouts | [PR #1236](https://github.com/samouraiworld/memba/pull/1236); required checks green, supplemental checks running; not merged/released |
| B3 first text proposal and vote | `f6ade1d58885b81077d185ad9943159718c8994e`; independent CTO + SWE approval after merging current main | Original slice full unit: 561 files, 5,609 tests; lint/build/bundle; production-code affected suite and wallet integration: 40 tests pass; test-only follow-up fixes an obsolete disconnected-edit expectation, with 56 DAO browser tests passing in Chromium/Firefox (4 fixture skips); mainnet synthetic wallet/RPC proposal → vote → read-back → reload passes Chromium, Firefox and iPhone WebKit; 320/390/1440px layouts pass; connected proposal-type editing remains covered | [PR #1237](https://github.com/samouraiworld/memba/pull/1237); hosted checks running; not merged/released |
