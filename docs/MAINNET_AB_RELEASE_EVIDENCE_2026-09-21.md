...
- Frontend commit: `ebb80e5da20e1be44626ab6d7cc1689931ce96eb`, v7.7.0, following the owner’s merge of #1236.
- Netlify site: `memba-multisig`; production deploy: `6ab197f4b20869000836ee2e` (published 2026-09-21 20:48 UTC). `build-info.json` identifies the exact merged commit and entry `assets/index-CezBapfx.js`.
- Custom domain and immutable deploy creation-page HTML share SHA-256 `02ac43efbaff151ae44aec0918c95f8c811426c87e7596447b322b5b7b7de509`. The returning production browser adopted the new entry after its service-worker update and reload; Home and mainnet Create a DAO rendered normally. A fresh immutable-origin browser rendered mainnet creation/list and Pearl creation. No wallet was connected or used.
