...
The verified production baseline is frontend v7.7.0 at `e6424909d3562f22edfc46d5af4304d45900d1cb`, with mainnet (`gnoland-1`) as the default network. This is a frontend deployment observation, not a claim that all shared realms or wallet journeys are ready on mainnet.
