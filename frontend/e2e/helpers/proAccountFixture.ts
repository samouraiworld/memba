...
export async function accountReviewFixture(page: Page) {
    await page.addInitScript(({ address }) => {
        ...
        localStorage.setItem('memba_auth_token', JSON.stringify({ nonce: 'design-fixture', userAddress: address, expiration: '2099-01-01T00:00:00Z', chainId: 'gnoland-1', serverSignature: 'invalid-test-only' }))
    ...
    await page.route('**/memba.v1.MultisigService/*', route => {
        ...
        const readResponses: Record<string, unknown> = {
            ...
            GetTransaction: { transaction: {
                ...
                chainId: 'gnoland-1', threshold: 2, membersCount: 3, memo: 'Community operations — design fixture',
