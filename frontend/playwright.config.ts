...
export default defineConfig({
    ...
    projects: [
        { name: 'chromium', use: { ...devices['Desktop Chrome'] }, testIgnore: [/release\//, /e2e\/os\//, /\.mobile\.spec\.ts$/, /validators-pro\.spec\.ts$/, /shell-pro\.spec\.ts$/, /governance-pro\.spec\.ts$/, /complete-design\.spec\.ts$/] },
        { name: 'firefox',  use: { ...devices['Desktop Firefox'] }, testIgnore: [/release\//, /e2e\/os\//, /\.mobile\.spec\.ts$/, /validators-pro\.spec\.ts$/, /shell-pro\.spec\.ts$/, /governance-pro\.spec\.ts$/, /complete-design\.spec\.ts$/] },
