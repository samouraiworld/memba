...
export default defineConfig({
    ...
    projects: [
        { name: 'chromium', use: { ...devices['Desktop Chrome'] }, testIgnore: [/\.mobile\.spec\.ts$/, /validators-pro\.spec\.ts$/] },
        { name: 'firefox',  use: { ...devices['Desktop Firefox'] }, testIgnore: [/\.mobile\.spec\.ts$/, /validators-pro\.spec\.ts$/] },
