        ...
        <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            <div>
                ...
                <button
                    ...
                    style={{
                        ...
                        color: "var(--color-text-secondary)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)", fontSize: "var(--pro-caption, 11px)",
                    }}
                >
            ...
            {showGuide && (
                <div className="k-card" style={{ padding: 22, display: "flex", flexDirection: "column", gap: 14 }}>
                    <p style={{ fontSize: "var(--pro-small, 13px)", lineHeight: 1.6, color: "var(--color-k-text)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)", margin: 0 }}>
                    ...
                    {[
                        ...
                        <div key={term} style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                            <span style={{ fontSize: "var(--pro-caption, 11px)", fontWeight: 600, color: "var(--color-k-accent)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)", textTransform: "uppercase", letterSpacing: "0.04em" }}>{term}</span>
                            <span style={{ fontSize: "var(--pro-small, 12px)", lineHeight: 1.55, color: "var(--color-text-secondary)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)" }}>{body}</span>
                        </div>
                    ))}
                    <p style={{ fontSize: "var(--pro-caption, 11px)", lineHeight: 1.55, color: "var(--color-text-muted)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)", margin: 0, borderTop: "1px solid var(--color-k-edge)", paddingTop: 12 }}>
            ...
            {success && !deployResult && (
                <div style={{ padding: "12px 16px", background: "var(--color-k-accent-subtle)", borderRadius: 8, border: "1px solid var(--color-k-accent-border)", color: "var(--color-primary)", fontSize: "var(--pro-small, 13px)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)" }}>
                    ✓ {success}
                </div>
            )}
            ...
            {parsedMint > 0n && !mintError && !overCap && (
                <div style={{
                    ...
                    fontSize: "var(--pro-small, 12px)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)", color: "var(--color-warning)",
                }}>
            ...
            <div className="k-card" style={{ padding: 18, display: "flex", flexDirection: "column", gap: 8 }}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "var(--pro-small, 12px)", fontFamily: "var(--font-ui, JetBrains Mono, monospace)" }}>
            ...
            <button
                ...
                style={{
                    ...
                    fontFamily: "var(--font-ui, JetBrains Mono, monospace)", fontSize: "var(--pro-body, 14px)", fontWeight: 600,
...
const hintStyle: React.CSSProperties = {
    ...
    fontFamily: "var(--font-ui, JetBrains Mono, monospace)", color: "var(--color-text-muted)",
}
