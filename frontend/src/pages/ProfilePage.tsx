...
import { fetchUserProfile, updateBackendProfile, type UserProfile, type GovVote } from "../lib/profile"
...
// ── My Votes section (own profile only) ───────────────────────────

function MyVotesSection({ address, gnoloveVotes }: { address: string; gnoloveVotes: GovVote[] }) {
