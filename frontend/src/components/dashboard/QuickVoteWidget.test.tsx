...
it("offers no vote buttons for read-only weighted proposals and links to their workspace", () => {
    ...
    expect(navigate).toHaveBeenCalledWith("/weighted-dao/gno.land/r/samcrew/memba_dao#proposal-85")
    fireEvent.click(screen.getByText(/#85/))
    expect(navigate).toHaveBeenLastCalledWith("/weighted-dao/gno.land/r/samcrew/memba_dao#proposal-85")
