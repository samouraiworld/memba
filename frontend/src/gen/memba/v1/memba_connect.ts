...
export const MultisigService = {
  ...
  methods: {
     ...
     */
    getFlaggedPosts: {
      name: "GetFlaggedPosts",
      I: GetFlaggedPostsRequest,
      O: GetFlaggedPostsResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    getLinkPreview: {
      name: "GetLinkPreview",
      I: GetLinkPreviewRequest,
      O: GetLinkPreviewResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    getPostReactions: {
      ...
      I: GetPostReactionsRequest,
      O: GetPostReactionsResponse,
      kind: MethodKind.Unary,
    },
  }
} as const;
