                            ...
                            <div key={pool.path} id={`pool-${pool.path}`} style={cardStyle}>
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                    <div>
                                        ...
                                        <span style={{
                                            fontSize: "var(--pro-caption, 10px)", marginLeft: 8, padding: "2px 6px",
        ...
        return (
            <div id="gnoswap-swap" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    <div>
                        <label style={{ fontSize: "var(--pro-caption, 11px)", color: "var(--color-text-secondary)", display: "block", marginBottom: 4 }}>Token In</label>
                        <input
                            id="swap-token-in"
                            type="text"
                    ...
                    <div>
                        <label style={{ fontSize: "var(--pro-caption, 11px)", color: "var(--color-text-secondary)", display: "block", marginBottom: 4 }}>Token Out</label>
                        <input
                            id="swap-token-out"
                            type="text"
                            list="swap-tokens-list"
                    ...
                    <div>
                        <label style={{ fontSize: "var(--pro-caption, 11px)", color: "var(--color-text-secondary)", display: "block", marginBottom: 4 }}>Amount In</label>
                        <input
                            id="swap-amount-in"
                            type="text"
                            placeholder="1000000"
                    ...
                    <div>
                        <label style={{ fontSize: "var(--pro-caption, 11px)", color: "var(--color-text-secondary)", display: "block", marginBottom: 4 }}>
                            Slippage Tolerance (%)
                        </label>
                        ...
                        {slippageWarning && (
                            <div style={{ color: "var(--color-warning)", fontSize: "var(--pro-caption, 11px)", marginTop: 4 }}>
