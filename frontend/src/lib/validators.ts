...
// formatPercent moved to ./formatPercent. The health engine needs it for its
// reason strings, and validatorHealth.ts already sits on the far side of a value
// import from this module (ValidatorHealthStatus); importing back from here
// would make that a runtime cycle. Re-exported so every existing import holds.
