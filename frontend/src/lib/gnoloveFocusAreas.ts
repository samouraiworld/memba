...
const SEED_TOPIC_RULES: TopicRule[] = [
    { topic: "gnovm", patterns: [/\(gnovm\)/, /\(gnolang\)/, /\bvm\b/, /interpreter/, /\bstack[- ]engine\b/, /gnomod/, /precompile/, /type-check/, /transpile/, /\bast\b/, /\bparser\b/] },
    { topic: "consensus", patterns: [/\(consensus\)/, /\bconsensus\b/, /\btendermint\b/, /\bbft\b/, /\bvalidator/, /\bvalset\b/, /val-scenarios/, /\bvalopers?\b/, /\(blockchain\)/, /\bblock\b/] },
    { topic: "gnocore", patterns: [/\(tm2\)/, /\(gnoland\)/, /\(node\)/, /gnogenesis/, /gnoland1/, /\bhardfork\b/, /\bamino\b/, /genproto/, /\bcore\b/, /\bprotocol\b/, /tm2/] },
    { topic: "realms", patterns: [/\(gno\.land\)/, /\brealm\b/, /\bpackage\b/, /boards2?/, /\bexamples?\)/, /\bbptree\b/, /grc20/, /\bavl\b/, /r\//, /p\//] },
    { topic: "gnosdk", patterns: [/\bsdk\b/, /\bjs-client\b/, /tx[- ]builder/] },
    { topic: "gnops", patterns: [/\(ci\)/, /\(build\)/, /portal[- ]loop/, /\binfra\b/, /deploy/, /\bops\b/, /\bci\b/, /\bfaucet\b/, /gnofaucet/, /\bcontribs?\b/, /\bgnobr\b/, /github-bot/] },
    { topic: "security", patterns: [/\bsecurity\b/, /\bauth\b/, /audit/, /multisig/, /signer/, /cve/] },
    { topic: "devx", patterns: [/gnopls/, /gno-?cli/, /gnodev/, /devx/, /\btooling\b/, /\blinter\b/, /\blsp\b/, /\(codegen\)/] },
    { topic: "frontend", patterns: [/gnoweb/, /\breact\b/, /\bvite\b/, /\bcss\b/, /\bui\b/, /component/, /\bux\b/, /\bfrontend\b/] },
    { topic: "testing", patterns: [/\btest\b/, /\bvitest\b/, /\be2e\b/, /coverage/, /\bci\/cd\b/, /\bbenchops?\b/] },
