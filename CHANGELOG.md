...
- **Juice-layer polish.** A rebel killed right at the barricade now pops correctly, the kill-sound pitch rises across several kills in the same frame instead of flattening to one note, and the audio context shuts down quietly. Cosmetic only, still behind the flag.
