...
- **Mainnet stays on hold.** On gnoland-1 no transaction is built for this contract and every control stays disabled. Role and key-recovery proposals for this contract version come later.
