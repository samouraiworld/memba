...
- **One entry point.** Opening a weighted DAO from the DAO pages goes to its workspace. Memba builds no transaction for this contract version on any network yet, and Quick Vote leaves it out until the contract can report a member's own ballot.
