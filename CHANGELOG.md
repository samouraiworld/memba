...
- **A stale Betanet selection now heals itself.** If your browser remembered Betanet, it is restored as Topaz instead of leaving you on a network you can no longer pick from the switcher. Betanet links you follow directly still open, and the switcher always lists the network you are actually on, so you can always move off it.
