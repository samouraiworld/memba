...
- **Chain:** Gno Pearl (chain id `pearl-1`, gno-core's official endpoints), gnoland1 (betanet). Sapphire (`sapphire-1`) sunsets 2026-09-09; Topaz (`topaz-1`) was decommissioned 2026-08-12 and Testnet 13 on 2026-07-26 — retired chains' RPCs and indexers refuse connections.
...
curl -s https://memba-backend.fly.dev/memba.v1.MultisigService/Multisigs \
  ...
  -d '{"userAddress":"g1ADDRESS","chainId":"pearl-1"}'
```
